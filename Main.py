...
# Import the Hands solution from MediaPipe
mp_hands = mp.solutions.hands
hands = mp_hands.Hands()

# Import the drawing utils solution from MediaPipe
mp_draw = mp.solutions.drawing_utils

# Open the default camera to capture video
cap = cv2.VideoCapture(0)

# List of finger tip indices
finger_tips = [8, 12, 16, 20]

# Index of thumb tip
thumb_tip = 4

# while loop to continuously capture video
while True:
    ret, img = cap.read()
    img = cv2.flip(img, 1)
    h, w, c = img.shape
